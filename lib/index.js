 ...
 */
Inherits(Statique, EventEmitter);
...
Statique.prototype.setRoutes = function (routes) {
    ...
    routes = self.routes = Ul.merge(self.routes, routes);
    self.regexpRoutes = [];
    ...
    Object.keys(routes).forEach(function (k) {
        ...
        if (cRoute.re.constructor.name !== "RegExp") {
            cRoute.re = RegexParser(typeof cRoute.re === "string" ? cRoute.re : k);
        }
