...
function Route(route, url) {
    ...
    switch (typeof route) {
        ...
        case "object":
            ...
            break;
        default:
            Logger.log("The should be a function, string or an object.", "warn");
            break;
    }
...
Statique.prototype.notFound = function (res, res) {
    return self.error(req, res, 404, "Not found");
};

Statique.prototype.serverError = function (res, res) {
    return self.error(req, res, 500, "Internal Server Error");
};
...
Statique.prototype.serveRoute = function (route, req, res) {
    ...
    // Call the handler
    if (typeof meth.handler === "function") {
        d.run(function() {
    ...
    // Serve the html page
    return self.serveFile(routeToServe.html, null, res, req);
};
